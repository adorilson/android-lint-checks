...
\section{Introdução}
    ...
    \frame
    {
        ...
        \begin{itemize}
            \item \cite{findbug_10k} analisa 10.000 mil aplicações Android gratuitas
            ...
            \end{itemize}
            \item Android Lint é utilizado em \cite{lintent}, que propõe um framework
    ...
    {   
        \frametitle{Limitações de Trabalhos Atuais}
        \begin{itemize}
            \item \cite{bad_practice_finder} utiliza Lint na busca por más práticas
